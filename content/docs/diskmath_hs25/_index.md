...
I also created [reading questions]({{% relref "reading_questions" %}}) for the first chapters of the script. Those are short quizzes you can do after reading the corresponding chapter to see if you understood what you just read or to recap it. Note that they are not in any way similar to exam questions and I won't include solutions for most of them, so if anything is unclear please ask in class!